...
_simulate_notify() {
	cangen vcan0 -I 8 -g 500 -D $IHB_MAGIC -L 8 & PID_IHB8="$!"
	cangen vcan0 -I 20 -g 1500 -D $IHB_MAGIC -L 8 & PID_IHB32="$!"
	cangen vcan0 -I 65 -g 400 -D $IHB_MAGIC -L 8 & PID_IHB101="$!"
	cangen vcan0 -I 121 -g 700 - & PID_IHB121="$!"
	cangen vcan0 -I 234 -g 900 & PID_IHB243="$!"
